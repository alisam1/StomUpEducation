    ...
    */
    ...
    var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
        ...
        SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            console.log(seg);
            if(eventRange.def.extendedProps.eventRealDateEnd != eventRange.def.extendedProps.eventRealDateStart){
            titleHtml =
                '<span class="fc-title"><div class="its_dottes_long" style="'+skinCss+'"></div><div class="am_long_event_text">' +
                    (core.htmlEscape(eventDef.title || '') || '&nbsp;') + // we always want one line of height
                    '</div></span>';
            } else {
              titleHtml =
                  '<span class="fc-title"><div class="its_dottes" style="'+skinCss+'"></div><div class="am_event_text">' +
                      (core.htmlEscape(eventDef.title || '') || '&nbsp;') + // we always want one line of height
                      '</div></span>';
            }
